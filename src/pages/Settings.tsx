          ...
          <TabsContent value="voice" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure voice training and accessibility options</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Voice training features are available in the enhanced settings panel.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
