    ...
    <div className="border-t border-b h-[300px] flex items-center justify-center bg-muted/50">
      <Tabs defaultValue="view" className="w-full h-full">
        <div className="flex flex-col h-full">
          ...
          <TabsContent value="view" className="flex-1 flex items-center justify-center">
          ...
          <TabsContent value="edit" className="flex-1 flex items-center justify-center">
            <div className="text-muted-foreground flex flex-col items-center">
              <GitMerge className="h-10 w-10 mb-2 opacity-70" />
          ...
          <TabsContent value="comments" className="flex-1 flex items-center justify-center">
            <div className="text-muted-foreground flex flex-col items-center">
              <GitMerge className="h-10 w-10 mb-2 opacity-70" />
